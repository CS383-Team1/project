...
\item sound and music (Ronnie) (DONE)
\item fix UI stuff: inventory/quest/etc linked to player stuff (Lance, various others) (MOSTLY DONE)
\item fix combat issues (Casey) (MOSTLY DONE)
\item finish/integrate network stuff if possible (Mason, Casey, various) (DONE)
\item all of the documentation (Arthur, Robin, also everyone else) (IN PROGRESS)
\item (this includes commenting the code) (COMMENT YOUR OWN DARN CODE) (...)
\item (this includes a game manual) (Arthur possibly?) (IN PROGRESS)
\item remove extraneous classes (Casey) (???)
\item new alien sprites and main menu images (Majeed) (DONEISH)
\item improved NPC stuff possibly (Majeed) (DONE)
\item software metrics probably (Tessa) (???)
\item more of the testing (integration and usability testing) (Lance, possibly) (???) 
\item initial menu possibly (Arthur) (DONE)
\item at least one level of each type (Ronnie) (DONE?) 

...
public class MenuQuests extends SubMenu {
        ...
        private void updateQuests()
        {
                ...
                for ( int i =0; i < questList.size(); i++ ) {
                        ...
                        questTable.add( new Label( name, skin, "big" ) )
				.expand().fill().padLeft(20).padRight(50).row();
                        questTable.add( new Label( details, skin ) )
				.colspan(2).row();
                        questTable.add( new Label( (Integer.toString(curCount)
        ...
        private void getDemoQuests()
        {
			...
			"Hustle yo' butt to the HR rep.", "talk", 0, 1) );
			...
			"Get the V.R. headsets from R&D.", "fetch", 0, 10) );
